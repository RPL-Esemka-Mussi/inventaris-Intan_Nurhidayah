                        ...
                        <div class="card-body">
                            <table class="table table-scriped table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td> {{ $user->telepon }} </td>
                                    <td>
                                        <a href="{{ url('user/edit/') . '/' . $user->id }}" class="btn btn-sm btn-outline-success">Edit</a>
                                        <a href="{{ url('user/delete/') . '/' . $user->id }}" class="btn btn-sm btn-outline-danger">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            ...
                            <div class="float-end mb-2 mt-1">
                                <a href="{{ url('/user/add')}}" class="btn btn-outline-primary">Add User</a>
                            </div>
                        </div>
                    </div>
                </div>
